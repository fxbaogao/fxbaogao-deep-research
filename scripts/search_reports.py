#!/usr/bin/env python3
"""Search research reports from fxbaogao."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="搜索发现报告中的研报（需要 API key）",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
示例:
    python3 search_reports.py "人工智能" --time last1mon --json
    python3 search_reports.py "半导体" --org "中信证券" --author "张三"
    python3 search_reports.py "新能源" --start-date 2025-01-01 --end-date 2025-03-31
        """,
    )
    ...
    parser.add_argument("--size", "-s", type=int, default=10, help="返回数量（默认 10，最大 100）")
